...
filters_config = {
    ...
    'flower-crown':
        [{'path': "filters/flower-crown.png",
          ...
          'morph': True, 'animated': False, 'has_alpha': True}],
    'glasses':
        [{'path': "filters/glass.png",
          'anno_path': "filters/glasses_annotations.csv",
          'morph': False, 'animated': False, 'has_alpha': True}],  
    'mustache':
        [{'path': "filters/mustache2.png",
          'anno_path': "filters/mustache_annotations.csv",
          'morph': True, 'animated': False, 'has_alpha': True}],          
}
...
def parse(args=None):
    ...
    parser.add_argument('--image', dest='image', type=str, default='custom/5.jpg')
